								...
								<table class="table table-bordered" style="margin-top:20px;">
                                    ...
                                    @foreach($productlist as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <img height="150px" width="200px" src="front/img/product/detail/product-{{$product->id}}.jpg" class="thumbnail">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{asset('admin/product/delete/')}}/{{$product->id}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                </td>
                                            </tr>
                                    @endforeach
									</tbody>
