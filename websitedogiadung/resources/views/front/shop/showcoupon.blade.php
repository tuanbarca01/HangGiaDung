...
<main>
        ...
        <section class="product__selection">
            <div class="container">
                <h2 style="font-size: 50px">MÃ GIẢM GIÁ</h2>
                <table style="margin:20px;width: 100%;border: 1px solid #0000">
                    <thead>
                    <tr>
                        <style>
                            th {font-size:20px; color:red;border: 1px solid}
                        </style>
                        <th>STT</th>
                    ...
                    <tbody>
                        @foreach($coupon as $cou)
                            <tr>
                                <style>
                                    td {font-size:20px; text-align: center;border: 1px solid}
                                </style>
